...
# Form implementation generated from reading ui file 'C:\Users\Will LSM\Downloads\AdvSettingsDialog.ui'
#
...
class Ui_AdvSettingsDialog(object):
    def setupUi(self, AdvSettingsDialog):
        ...
        AdvSettingsDialog.resize(437, 372)
        ...
        self.end_videos_label.setGeometry(QtCore.QRect(160, 260, 101, 20))
        ...
        self.end_videos_check_box.setGeometry(QtCore.QRect(160, 280, 141, 20))
        self.end_videos_check_box.setObjectName("end_videos_check_box")
        self.end_video_exp_unit_label = QtWidgets.QLabel(AdvSettingsDialog)
        self.end_video_exp_unit_label.setGeometry(QtCore.QRect(270, 340, 21, 16))
        self.end_video_exp_unit_label.setAlignment(QtCore.Qt.AlignCenter)
        self.end_video_exp_unit_label.setObjectName("end_video_exp_unit_label")
        self.end_video_exposure_label = QtWidgets.QLabel(AdvSettingsDialog)
        self.end_video_exposure_label.setGeometry(QtCore.QRect(130, 340, 81, 20))
        self.end_video_exposure_label.setObjectName("end_video_exposure_label")
        self.end_video_exposure_line_edit = QtWidgets.QLineEdit(AdvSettingsDialog)
        self.end_video_exposure_line_edit.setGeometry(QtCore.QRect(210, 340, 61, 20))
        self.end_video_exposure_line_edit.setObjectName("end_video_exposure_line_edit")
        self.end_video_num_frames_label = QtWidgets.QLabel(AdvSettingsDialog)
        self.end_video_num_frames_label.setGeometry(QtCore.QRect(110, 310, 101, 20))
        self.end_video_num_frames_label.setObjectName("end_video_num_frames_label")
        self.end_video_num_frames_line_edit = QtWidgets.QLineEdit(AdvSettingsDialog)
        self.end_video_num_frames_line_edit.setGeometry(QtCore.QRect(210, 310, 61, 20))
        self.end_video_num_frames_line_edit.setObjectName("end_video_num_frames_line_edit")
    ...
    def retranslateUi(self, AdvSettingsDialog):
        ...
        self.end_video_exp_unit_label.setText(_translate("AdvSettingsDialog", "ms"))
        self.end_video_exposure_label.setText(_translate("AdvSettingsDialog", "Exposure Time:"))
        self.end_video_exposure_line_edit.setWhatsThis(_translate("AdvSettingsDialog", "<html><head/><body><p>Exposure time for use in Z-stack. </p><p>If spectral Z-stack is enabled, exposure time is only limited by camera\'s min/max exposure time. </p><p>If both spectral Z-stack and custom exposure are disabled, exposure time will be ~ 1/stage_speed</p><p>If spectral Z-stack is disabaled but custom exposure is enabled, allowed exposure time is determined by camera\'s allowed exposure in external trigger mode. See Hamamatsu documentation for more details.</p></body></html>"))
        self.end_video_num_frames_label.setText(_translate("AdvSettingsDialog", "Number of Frames:"))
        self.end_video_num_frames_line_edit.setWhatsThis(_translate("AdvSettingsDialog", "<html><head/><body><p>Exposure time for use in Z-stack. </p><p>If spectral Z-stack is enabled, exposure time is only limited by camera\'s min/max exposure time. </p><p>If both spectral Z-stack and custom exposure are disabled, exposure time will be ~ 1/stage_speed</p><p>If spectral Z-stack is disabaled but custom exposure is enabled, allowed exposure time is determined by camera\'s allowed exposure in external trigger mode. See Hamamatsu documentation for more details.</p></body></html>"))
