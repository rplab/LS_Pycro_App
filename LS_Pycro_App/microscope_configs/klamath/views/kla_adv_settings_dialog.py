...
# Form implementation generated from reading ui file 'C:\Users\Will LSM\Desktop\Microscope Software\LS_Pycro_App\LS_Pycro_App\microscope_configs\klamath\views\ui_files\KlaAdvSettingsDialog.ui'
#
...
class Ui_AdvSettingsDialog(object):
    def setupUi(self, AdvSettingsDialog):
        ...
        AdvSettingsDialog.resize(431, 221)
        self.acq_order_combo_box = QtWidgets.QComboBox(AdvSettingsDialog)
        self.acq_order_combo_box.setGeometry(QtCore.QRect(290, 30, 81, 22))
        ...
        self.video_spectral_check_box.setGeometry(QtCore.QRect(50, 160, 121, 20))
        ...
        self.video_settings_label.setGeometry(QtCore.QRect(50, 130, 101, 20))
        ...
        self.line_2.setGeometry(QtCore.QRect(210, -130, 20, 351))
        self.line_2.setFrameShadow(QtWidgets.QFrame.Plain)
        self.line_2.setLineWidth(4)
        self.line_2.setFrameShape(QtWidgets.QFrame.VLine)
        self.line_2.setObjectName("line_2")
        self.acq_order_label = QtWidgets.QLabel(AdvSettingsDialog)
        self.acq_order_label.setGeometry(QtCore.QRect(280, 0, 91, 20))
        ...
        self.save_label.setGeometry(QtCore.QRect(230, 190, 91, 20))
        self.save_label.setObjectName("save_label")
        self.backup_directory_browse_button = QtWidgets.QPushButton(AdvSettingsDialog)
        self.backup_directory_browse_button.setGeometry(QtCore.QRect(290, 160, 75, 23))
        ...
        self.backup_directory_line_edit.setGeometry(QtCore.QRect(330, 190, 81, 20))
        ...
        self.backup_directory_check_box.setGeometry(QtCore.QRect(270, 130, 121, 20))
        self.backup_directory_check_box.setObjectName("backup_directory_check_box")
        self.line_4 = QtWidgets.QFrame(AdvSettingsDialog)
        self.line_4.setGeometry(QtCore.QRect(220, 50, 351, 20))
        font = QtGui.QFont()
        font.setPointSize(8)
        ...
        self.line_5.setGeometry(QtCore.QRect(-30, 210, 491, 20))
        font = QtGui.QFont()
        font.setPointSize(8)
        ...
        self.lsrm_check_box.setGeometry(QtCore.QRect(300, 90, 51, 20))
        self.lsrm_check_box.setObjectName("lsrm_check_box")
        self.lsrm_label = QtWidgets.QLabel(AdvSettingsDialog)
        self.lsrm_label.setGeometry(QtCore.QRect(250, 70, 151, 20))
        ...
        self.line_7.setGeometry(QtCore.QRect(210, 110, 491, 20))
        font = QtGui.QFont()
        font.setPointSize(8)
    ...
    def retranslateUi(self, AdvSettingsDialog):
        ...
        self.z_stack_settings_label.setText(_translate("AdvSettingsDialog", "Z-Stack Settings"))
        ...
        self.video_settings_label.setText(_translate("AdvSettingsDialog", "Video Settings"))
        ...
        self.acq_order_label.setText(_translate("AdvSettingsDialog", "Acquisition Order:"))
        ...
        self.lsrm_check_box.setText(_translate("AdvSettingsDialog", "LSRM"))
        self.lsrm_label.setText(_translate("AdvSettingsDialog", "Lightsheet Readout Mode"))
